...
{
    public class RightAttacker : Attacker
    {
        public RightAttacker(Team team, ICoach coach) : base(team, coach)
        {
            ...
            while (!m_timeOver)
            {
             ...
             //   m_memory.waitForNewInfo();
               ...
               // GetData();
                ...
                if (CheckQuerter(quarter, ballObj) || CheckQuerter(q2, ballObj))
                {
                    var player2 = m_coach.GetSeenCoachObject($"player Brazil 5");
                    ...
                    //{
                        ...
                        else
                        {
                            ...
                            else if (myPlayer.DistanceTo(ballObj) > 25)
                                m_robot.Kick(40, myPlayer.AngleToKick(ballObj) + angle);
                            else
                                m_robot.Kick(150, myPlayer.AngleToKick(ballObj) + 10);
                ...
                //else
                //{
                //    Quarter quarter2 = m_side == 'l' ? Quarter.RightUp : Quarter.LeftDown;
